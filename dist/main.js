...
const taskInterface = {
  ...
  findDueToday() {
    ...
    this.todos.forEach((todo) => {
      if ((0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(todo.todoDueDate, "MM/dd/yyyy") === todayDate) {
        arr.push(todo);
      }
    });
    return arr;
